...
async function assertInfrastructureClean() {
  ...
  const status = await commandOutput("git", [
    ...
    "public/assets/favicon-v1.svg", "public/assets/frontier-mark-favicon-v1.png",
    "public/assets/frontier-mark-white-v1.png", "public/assets/frontier-passage-v1.jpg",
    "public/assets/frontier-theme-v16.css", "public/assets/frontier-theme-v17.css",
    "public/assets/frontier-theme-v18.css", "public/assets/frontier-theme-v19.css",
    "public/assets/frontier-theme-v20.css",
    "public/assets/frontier-theme-v21.css",
...
async function verifyLive(article) {
  ...
  const checks = [
    ...
    ["https://signals.frontierworld.ai/assets/frontier-theme-v19.css", join(distDirectory, "assets", "frontier-theme-v19.css")],
    ["https://signals.frontierworld.ai/assets/frontier-theme-v20.css", join(distDirectory, "assets", "frontier-theme-v20.css")],
    ["https://signals.frontierworld.ai/assets/frontier-theme-v21.css", join(distDirectory, "assets", "frontier-theme-v21.css")],
    ["https://signals.frontierworld.ai/assets/frontier-mark-white-v1.png", join(distDirectory, "assets", "frontier-mark-white-v1.png")],
    ["https://signals.frontierworld.ai/assets/frontier-mark-favicon-v1.png", join(distDirectory, "assets", "frontier-mark-favicon-v1.png")],
