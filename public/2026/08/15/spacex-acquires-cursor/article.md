# SpaceX 收购 Cursor，把大规模算力接进代码编辑器

> SpaceX 正式收购 Cursor，把大规模算力接到编程模型和开发者产品上。资源已经接通，产品结果仍要由新版本、价格和数据政策证明。

**Frontier Signals · 2026.08.15 · 6 分钟**

[微信公众号原文](https://mp.weixin.qq.com/s/TUCL3WKNNyRueW7Rgg1Ddg)

![Frontier Signals：SpaceX 收购 Cursor，把大规模算力接进代码编辑器](./og.png)

## 01 · Cursor 正式进入 SpaceX
...
![黑色背景上的 Cursor 与 SpaceX 联合标志](./images/source/cursor-joins-spacex.png)
...
![Cursor 4 月 21 日官方合作公告移动端截图，提到 Composer 1.5、Composer 2 和 Colossus](./images/source/cursor-spacex-training-mobile.png)

*Cursor 于 4 月 21 日公布与 SpaceX 的模型训练合作*
...
![Cursor Models & Pricing 文档移动端截图，列出 Cursor Models 与 Other Models 两个使用池](./images/source/cursor-model-pools-mobile.png)

*Cursor 当前把第一方模型和第三方模型放在两个使用池中*
...
- [微信公众号原文](https://mp.weixin.qq.com/s/TUCL3WKNNyRueW7Rgg1Ddg) · Frontier World
- [Cursor is now a part of SpaceX](https://cursor.com/blog/joining-spacex) · Cursor
- [Cursor partners with SpaceX on model training](https://cursor.com/blog/spacex-model-training) · Cursor
- [Models & Pricing](https://cursor.com/docs/models-and-pricing) · Cursor Docs
- [Data Use & Privacy Overview](https://cursor.com/data-use) · Cursor
